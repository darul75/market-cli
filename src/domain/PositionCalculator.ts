import type { PositionSummary, Transaction, TransactionWithPL } from "./Position.js";
...
export function calculateTransactionPL(transaction: Transaction, currentPrice: number): TransactionWithPL {
	...
	const currentValue = transaction.type === "BUY" ? transaction.qty * currentPrice : transaction.qty * currentPrice;
...
export function calculatePositionSummary(transactions: Transaction[], currentPrice: number): PositionSummary {
...
export function calculateTransactionsWithPL(transactions: Transaction[], currentPrice: number): TransactionWithPL[] {
